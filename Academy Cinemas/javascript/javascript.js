...
$(document).on("scroll", function() {
    ...
    if ($(document).scrollTop() > 50) {
        ...
        //Adjusts the position of the mobile drop menu
        ...
        //The margin for the drop menu is now
...
$(document).ready(function () {
    ...
    //also close when an element with the class /droppdown-item (each movie link) has been clicked
